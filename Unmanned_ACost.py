...
def ACost(Node_1,Node_2_x, Node_2_y, Node_cost) -> float:
        ...
        for i in domain_gs:
           checking = Node(current_node.x + i, current_node.y + j,
                           ...
                           Cost(current_node, current_node.x + i, current_node.y + j, current_node.cost),\
                               ACost(current_node, current_node.x + i, current_node.y + j, current_node.cost)) 
...
#location and if so, stores the lowest cost found for the current location as the node.
           ...
           if checking_index in unvisited_nodes:
               if (unvisited_nodes[checking_index].Acost + unvisited_nodes[checking_index].cost) > (checking.Acost + checking.cost):
...
visited_nodes[0.0] = Node(0, 0, -1, 0,0)
